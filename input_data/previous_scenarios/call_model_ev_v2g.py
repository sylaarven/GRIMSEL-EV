...
import model_loop_modifier.model_loop_modifier_ev_v2g as model_loop_modifier
...
sc_out = os.path.abspath('C:/Users/sylaarv1/Desktop/Work/Second Paper/outputV2Gonly')
# sc_out = os.path.abspath('/home/users/s/syla/output_files/ev_v2g/')
# %%
...
# run_parallel(ml, run_model, 3, groupby=['swev','swv2g', 'swtr', 'swhp','swrf','swdpf'], adjust_logger_levels=True)
# run_parallel(ml, run_model, 3, groupby=['swev','swv2g', 'swtr'], adjust_logger_levels=True)
