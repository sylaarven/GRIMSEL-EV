...
class ModelLoopModifier():
    ...
    def set_future_year(self, slct_ch, slct_ev, slct_v2g, slct_tr, slct_hp, slct_rf, slct_dpf, dict_fy=None):
        ...
        nd_arch_v2g = self.ml.m.df_def_node.loc[self.ml.m.df_def_node.nd.str.contains('V2G')].nd_id.tolist()
        nd_arch_el = list(set(nd_arch) - set(nd_arch_ht) - set(nd_arch_dsr) - set(nd_arch_ev) - set(nd_arch_v2g))
        nd_arch_el_res = list(set(nd_arch_res) - set(nd_arch_ht) - set(nd_arch_dsr) - set(nd_arch_ev) - set(nd_arch_v2g))
