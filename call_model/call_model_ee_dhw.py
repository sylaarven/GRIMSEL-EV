...
import model_loop_modifier_ee_dhw as model_loop_modifier
...
sc_out = os.path.abspath('...../output/test_full_multi')
...
##                                    ],
                ...
                # ['CH0','IND_SUB','SFH_SUB_2','SFH_SUB_HT_2',
                # 'MFH_RUR_2','MFH_RUR_HT_2'],
...
#                   ('hom', range(24))
           ...
           'constraint_groups': 
               MB.get_constraint_groups(excl=['ror','supply']),#,'supply' BE CAREFUL WITH THIS
#               'chp','chp_new']),
...
nsteps_default = [('swfy', 8, np.arange),    # future years
                  ...
                  ('swdpf', 2, np.arange),    # original, EE loads and best
