...
import model_loop_modifier.model_loop_modifier_ev_res_ev_others_v2g_hpc as model_loop_modifier
...
df_plant_encar = pd.read_csv(os.path.join(config.PATH_CSV, 'plant_encar.csv'))
