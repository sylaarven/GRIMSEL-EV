# -*- coding: utf-8 -*-
"""
Created on Thu Feb 14 12:26:39 2024
...
import model_loop_modifier.model_loop_modifier_ev as model_loop_modifier
...
sc_out = os.path.abspath('C:/Users/sylaarv1/Desktop/Work/Second Paper/outputEVonly')
# sc_out = os.path.abspath('/home/users/s/syla/output_files/ev_only/')
# %%
...
nd_arch_el_res = list(set(nd_arch_el_res) - set(nd_arch_ev) - set(nd_arch_ht) - set(nd_arch_dsr))
...
nhours_dict_ev = {nd: (1,1) for nd in nd_arch_ev_str}
...
# run_parallel(ml, run_model, 3, groupby=['swev', 'swtr', 'swhp','swrf','swdpf'], adjust_logger_levels=True)
